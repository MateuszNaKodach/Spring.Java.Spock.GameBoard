...
class PiecePositionFixture {
    ...
    static final PiecePosition facingNorth = facing(NORTH);
    static final PiecePosition facingEast = facing(EAST);
    static final PiecePosition facingSouth = facing(SOUTH);
    static final PiecePosition facingWest = facing(WEST);
